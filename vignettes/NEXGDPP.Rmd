...
```{r}
NEX_GDPP.precipitationMaster <- system.file('extdata/NEX_GDPPswat',
                                         'prGrid_Master.txt', 
                                         package = 'NASAaccess')

NEX_GDPPswat.table<-read.csv(NEX_GDPP.precipitationMaster)

head(NEX_GDPPswat.table)

dim(NEX_GDPPswat.table)
```
...
Changing `type` parameter in the `NEX_GDPPswat` function from `pr` to `tas` gives us minimum and maximum air temperatures.
